...
if [ "$#" -eq 7 ]; then
        ...
        begin_time=${5}
        end_time=${6}
        script_dir=${7}/hana_dbop_comparison
else
        echo "Parameter missing"
        echo "Usage: $0 db_sid db_inst_no schemaName db_password begin_time end_time script_dir"
        exit 1
fi
...
- 2025/04/21:  4.2 (new ORDER_BY option CONNDUR for sorting by connections in terms of longest running threads)
[INVOLVED TABLES]
...
- SITE_ID
  ...
  1                 --> Site ID 1
  CURRENT_SITE_ID() --> Current primary site ID
- HOST
  Host name
...
- ORDER_BY
  ...
  'CONNDUR'       --> Sorting by connections based on their duration
[OUTPUT PARAMETERS]
...
( SELECT
  ...
  ( SELECT                                                      /* Modification section */
      ...
      'HASH' AGGREGATE_BY,                /* TIME, SITE_ID, HOST, PORT, THREAD_ID, THREAD_TYPE, THREAD_METHOD, THREAD_STATE, THREAD_DETAIL, HASH, ROOT, STATEMENT_ID, STAT_EXEC_ID, DB_USER, APP_NAME,
                                             APP_USER, APP_SOURCE, APP_COMP_NAME, APP_COMP_TYPE, CLIENT_IP, CLIENT_PID, CONN_ID, LOCK_NAME, LOCKS_OWNED, BLK_THREAD, CALLER, CALLING, NUMA_NODE, TABLE,
      ...
      'COUNT' ORDER_BY               /* COUNT, TIME, CONN_ID, DURATION, CONNDUR */
    FROM
      DUMMY
  )
),
...
( SELECT
    ...
    CASE
      ...
      WHEN T.STATEMENT_HASH IN ( '2aebdbfdf69d7dbecbd54e76fe716e5e', '54c121cd936dcab94fcb55c18882f3b0' ) THEN '-- ESH_SEARCH --'
...
( SELECT
    ...
    ( '4e498f19bb992a89791e1e96d9c2e1c8', '6d0bbcc90f4fddebe3cd16b07b6e3519', 'd4e254ec9866d451822a78b791c36e16', '6413f16e8a2709f7cd094042db84e2a5', '2e9d6d1d68ac89c78a3dba5e532ca308',
      ...
      '09132d6a122274db4936061ea1dbc1d3', '05a97129d0423f7be8df768d43a5315c', '04f5ae7626ca31d30a80c6f9bc8a1fed', '56fb56c5b5e26b468c443ea4fcc753ea', 'fa761f71c24bb95570ed769eedb02c8e',
      '697ee3facf1042240cc11332fb155750', '42f698f2feb195eb00f5006d165e7962', 'ac62ff5bd6ee687c2b4ff3ded15ca13d', 'fcad3b3f37c0ea4486f3f9ad527a76b5', '8dbf892a1ed0e7ffe105b29b5a7c7c22',
      '019e630fbd3d861f452b554ca7c36372', '1681c4d97d2e6e073da9c7a3814201fc', '9685c611f1e23121c574ff5687828587', 'a1a5e944c3311a1fa5096ec54d96a3fe', 'bda653dd2fc902fb91efbe4266fcb095',
      'cbb712f9955fee648a33b51eb9092319', 'f849c95e1d0c96281d2c061b490f428c', 'fce31bbf112498c1fcac7b6410f4c147', '1360603aa269c445f54b56e0f65974d1', '5b5e95d2cac09c793e4ca501e04e85b5',
      '14ea6db9675b684a8994a9c20925f8d2', '21ab6129bb995ac149040405d11dec94', '8030d4428fdf75044446261e90f1fd05', 'a27cb3a1774844826f7df3414a0f4877', '9419a42d0bb032c658377e17ba0946a2',
      'a7c53b1178c9cc6cf563f6dec55165be', '2662dbecf6fd54b71973645444d06022', '9504757760083589d8c5cf2944513377', '94169a815e3a4580a8caa1ca011df70e', 'dc1ddf47ee1388896cabcb2a9334116f',
      '86cb364530e57840daa8f5bba72622b1', '0873cb0b1df37472258d298266cd3022', '9ca622caae44be5491998fc6767d478c', 'aacfbd4614e00d4c68ba60daa5df96e3', '889d74a4993e9563fd3265aef0217356',
      '9e03dcc20fb52b8afaa4461d07a60d26', '6178ec308bdd8b3a13a6c0f0694cbd69', '67130e143e654bed4d6fdcedcd8092d8', '2cd130a15f96a357a7d327c95aad8836', '9c5411aeed36d1b4e1d9202256a544cd',
      'd444388b8308147fc383d1411aabaa91', '32263a543955c9417c005a40b91caab2', '007bfd70f047de4d885e70e3957c72b7', 'd772ff9eed2941bf508ab4bc1b9b377d', 'dc1ddf47ee1388896cabcb2a9334116f',
      'fbb37d51777a2f0fa120310db1af9e43', 'dc46e883aa2f2fd10ce2838e671af764', '6321765843970cfaf98207318d7f8129', 'e3694c71dc4e92e778b11b81f830f6b1', '28440a2d442e79678ccaa0d513d7f18f',
      '3360627782f5e04efd647dc297b783ef', '0d5f103a27a50235819cc36cdbd9baa2', 'f06917f833a9e46faffeb3b77c4b5c9d', '1d55b692252bc3ce2f5d1721b022168e', '3bfcf18dff878c9b1be1dda6ddf881ee',
      'bb18727b03b80904dd8bd21f5fec0d3e', 'f7a6f19f3e638728bb6d655f3c737217', '78da8887b9acb43c912a198bec8a0897', '54c121cd936dcab94fcb55c18882f3b0', 'ac76f2740dfce510f900b3614719804d',
      '768026546553ffaad2697b0d00f0d0f1', '3ac3411ba00d1a9f905cd6165867d402', '25ff45eebf5f58c5f9e2d6bc4a8db04e', '8b0d3193532fce6c365cd4f0666e855d', 'a495e08128a634ec6866dbaa4ac5bf11',
      '4bd60179567fc6567f1b46f0c464ce88', 'a6c93aa5cd4166996e09b6ba43c03362', '5e9443d89d52bf42b273184e275038fd', 'b94e1416e56c70a7917109853f5c8f94', 'cf279ac471ed5100799ef5757f7709eb',
      '1534dcf66e3e2e95bcf2a9803dc166ec', '7ed8f616c77e762f0cc57665a01435f9'
    ...
    WHERE
      ...
      ( BI.ONLY_TABLE_OPTIMIZATIONS = ' ' OR
        ...
        ( 'admin/mergeDeltaIndex', 'admin/mergeDeltaIndexForParts', 'changeCompression', 'ChangeCompressionJob', 'changeRowOrder', 'csddl/OptimizeCompressionData',
          ...
          'GetOptimizerCandidateJob', 'merge', 'merge delta', 'Mergedog MergeJob', 'MergedogMonitor', 'MergeDuringRecoveryJob_DeltaToMainMerge',
      ...
      ( BI.EXCLUDE_PHANTOM_THREADS = ' ' OR NOT
        ( T.THREAD_STATE = 'WaitForFetch'                                                                                                                                                           OR
          ...
          T.THREAD_TYPE = 'JobWorker'                           AND T.THREAD_STATE = 'Network Poll'              AND T.THREAD_METHOD = 'DML_MULTICAST_ASYNC'                                        OR
          ...
          T.THREAD_TYPE = 'JobWorker'                           AND T.THREAD_STATE = 'Semaphore Wait'            AND T.LOCK_NAME = 'DPPingIndexServerThreadSemaphore'                               OR
          ...
          T.THREAD_TYPE = 'JobWorker'                           AND T.THREAD_STATE = 'Semaphore Wait'            AND T.LOCK_NAME = 'hex_DistributedContext_receiveSemaphore'                        OR
          ...
          T.THREAD_TYPE = 'PushBufferIntoReplayThread'          AND T.THREAD_STATE = 'Semaphore Wait'            AND T.LOCK_NAME = 'SystemReplication: PushSemaphore'                               OR
          ...
          T.THREAD_TYPE = 'WaitAgentMDSCloseManager'            AND T.THREAD_STATE = 'Semaphore Wait'            AND T.LOCK_NAME = 'MDSCloseQueueRequestAvailable'                                  OR
...
TMP_SQL="${script_dir}/hana_thread_samples_${ts}.sql"
OUTPUT_FILE="${script_dir}/hana_thread_samples_${ts}.out"
...
# --- Extract the top 3 STATEMENT_HASH values (rows are already ORDER BY sample count DESC) ---
...
top_hashes="$("${PYEXE}" - "${OUTPUT_FILE}" <<'PYEOF'
import csv
import sys
